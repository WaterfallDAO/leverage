...
contract CErc20Delegator is CTokenInterface, CErc20Interface, CDelegatorInterface {
    ...
    function _setComptroller(ComptrollerInterface newComptroller) public returns (uint) {
        bytes memory data = delegateToImplementation(
            abi.encodeWithSignature("_setComptroller(address)",
            newComptroller));
        return abi.decode(data, (uint));
    }

    function _setRiskControl(address _address) public returns (uint) {
        bytes memory data = delegateToImplementation(
            abi.encodeWithSignature("_setRiskControl(address)",
            _address));
        return abi.decode(data, (uint));
    }
    ...
    function _setFeeManager(address payable _feeManager) external returns (uint) {
        bytes memory data = delegateToImplementation(
            abi.encodeWithSignature("_setFeeManager(address)",
            _feeManager));
        return abi.decode(data, (uint));
    }
    ...
    function _setRedeemFeeFactorMantissa(uint _redeemFee) external returns (uint) {
        bytes memory data = delegateToImplementation(
            abi.encodeWithSignature("_setRedeemFeeFactorMantissa(uint256)",
            _redeemFee));
        return abi.decode(data, (uint));
    }
    ...
    function _setBorrowFeeFactorMantissa(uint _borrowFee) external returns (uint) {
        bytes memory data = delegateToImplementation(
            abi.encodeWithSignature("_setBorrowFeeFactorMantissa(uint256)",
            _borrowFee));
        return abi.decode(data, (uint));
    }
    ...
    function flashLoan(
        ...
        bytes memory data = delegateToImplementation(
            ...
            _receiver, _reserve, _amount, _params));
        return abi.decode(data, (uint));
    }
    ...
    function _setInterestRateModel(InterestRateModel newInterestRateModel) public returns (uint) {
        bytes memory data = delegateToImplementation(
            abi.encodeWithSignature("_setInterestRateModel(address)",
