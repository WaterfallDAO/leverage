...
//    event CompSpeedUpdated(CToken indexed cToken, uint supplySpeed);
    ...
    uint public constant comBorrowRatio = 0.53e18;
    uint public constant comSupplyRatio = 0.47e18;
    ...
    function refreshCompSpeedsInternal() internal {
        ...
        for (uint i = 0; i < allMarkets_.length; i++) {
            ...
            if (market.isComped) {
                ...
                Exp memory utility = mul_(assetPrice, cToken.totalSupply());
                utilities[i] = utility;
...
//            emit CompSpeedUpdated(cToken, newSpeed);
    ...
    function updateCompSupplyIndex(address cToken) internal {
        ...
        uint supplySpeed = div_(mul_(compSpeeds[cToken], comSupplyRatio), expScale);
    ...
    function updateCompBorrowIndex(address cToken, Exp memory marketBorrowIndex) internal {
        ...
        uint borrowSpeed = div_(mul_(compSpeeds[cToken], comBorrowRatio), expScale);
        uint blockNumber = getBlockNumber();
