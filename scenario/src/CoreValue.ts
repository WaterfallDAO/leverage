...
const fetchers = [
    ...
    new Fetcher<{ addr: AddressV; slot: NumberV; start: NumberV; valType: StringV },
    ...
    * "StorageAt addr:<Address> slot:<Number> start:<Number>, valType:<VToCastTo>" - Returns bytes at storage slot
    ...
    new Fetcher<{ addr: AddressV; slot: NumberV; key: AddressV; nestedKey: AddressV; valType: StringV },
        ListV | NothingV>(
        `
    ...
    * "StorageAtNestedMapping addr:<Address> slot:<Number>, key:<address>, nestedKey:<address>, valType:<VToCastTo>" - Returns bytes at storage slot
    ...
    new Fetcher<{ addr: AddressV; slot: NumberV; key: AddressV; valType: StringV },
