...
describe('ComptrollerV1', function () {
    ...
    let initializeBrains = async (priceOracle, closeFactor, maxAssets) => {
        ...
        return await saddle.getContractAt('ComptrollerG1', brains._address);
    };
    ...
    describe('delegating to comptroller v1', () => {
        ...
        beforeEach(async () => {
            ...
            await send(unitrollerAsComptroller, "_setMaxAssets", [maxAssets]);
            await send(unitrollerAsComptroller, "_setPriceOracle", [oracle._address]);
        ...
        describe('becoming brains sets initial state', () => {
            ...
            it("on reinitialization success, it doesn't set closeFactor or maxAssets", async () => {
                ...
                // expect(await call(unitroller, 'comptrollerImplementation')).toEqual(brains._address);
                expect(await call(comptroller, 'closeFactorMantissa')).toEqualNumber(0);
        ...
        describe('_supportMarket', () => {
            ...
            it('can list two different markets', async () => {
                const cToken1 = await makeCToken({comptroller: unitrollerAsComptroller});
                const cToken2 = await makeCToken({comptroller: unitrollerAsComptroller});
