    ...
    describe('#repayRepay', () => {
        ...
        it.skip('can have partial failure succeed', async () => {
            ...
            const {
                '0': err0,
                '1': err1
            } = await spinarama.methods.repayRepay(BAT._address, 100, 1).call({from: accounts[0]});
    ...
    describe('#borrowRepayBorrow', () => {
        ...
        it.skip('can succeed with partial failure', async () => {
            ...
            const {
                '0': err0,
                '1': err1
            } = await spinarama.methods.borrowRepayBorrow(BAT._address, 1, 1000).call({from: accounts[0]});
